...
export default {
  ...
  SUPABASE_ANON_KEY:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1jYWhhcWRscnF4YWZrZ2lycWJ1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjE5ODUxMTcsImV4cCI6MjA3NzU2MTExN30.5p5RFQD5SJP6NaHs77bBz4mvylMiJNW4ONT3Hn-xF8U",
  // Apple Sign-In configuration (configure these in Apple Developer Console)
  APPLE_SERVICE_ID: "com.ngocdevv.vocabai.service",
  APPLE_REDIRECT_URI: "https://mcahaqdlrqxafkgirqbu.supabase.co/auth/v1/callback",
  // Google OAuth configuration (get this from Google Cloud Console)
