...
const fr: Translations = {
  ...
  registerScreen: {
    register: "S'inscrire",
    createAccount: "Créer un compte",
    enterDetails: "Entrez vos informations ci-dessous pour créer votre compte et commencer.",
    emailFieldLabel: "E-mail",
    passwordFieldLabel: "Mot de passe",
    confirmPasswordFieldLabel: "Confirmer le mot de passe",
    emailFieldPlaceholder: "Entrez votre adresse e-mail",
    passwordFieldPlaceholder: "Choisissez un mot de passe sécurisé",
    confirmPasswordFieldPlaceholder: "Ressaisissez votre mot de passe",
    tapToRegister: "Créer un compte",
    ...
    errors: {
      ...
      emailInvalid: "Doit être une adresse e-mail valide",
