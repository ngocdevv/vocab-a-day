...
const ja: Translations = {
  ...
  registerScreen: {
    register: "登録",
    createAccount: "アカウントを作成",
    enterDetails: "以下に詳細を入力して、アカウントを作成して開始してください。",
    emailFieldLabel: "メールアドレス",
    passwordFieldLabel: "パスワード",
    confirmPasswordFieldLabel: "パスワードの確認",
    emailFieldPlaceholder: "メールアドレスを入力してください",
    passwordFieldPlaceholder: "安全なパスワードを選択してください",
    confirmPasswordFieldPlaceholder: "パスワードを再入力してください",
    tapToRegister: "アカウントを作成",
    orContinueWith: "",
    signUpWithGoogle: "",
    signUpWithApple: "",
    ...
    logIn: "ログイン",
    errors: {
      emailRequired: "メールアドレスは空白にできません",
      emailInvalid: "有効なメールアドレスである必要があります",
      passwordRequired: "パスワードは空白にできません",
