...
const es: Translations = {
  ...
  registerScreen: {
    ...
    createAccount: "Crear cuenta",
    enterDetails: "Ingresa tus datos a continuación para crear tu cuenta y comenzar.",
    emailFieldLabel: "Email",
    passwordFieldLabel: "Contraseña",
    confirmPasswordFieldLabel: "Confirmar contraseña",
    emailFieldPlaceholder: "Ingresa tu email",
    passwordFieldPlaceholder: "Elige una contraseña segura",
    confirmPasswordFieldPlaceholder: "Vuelve a ingresar tu contraseña",
    tapToRegister: "Crear cuenta",
    orContinueWith: "",
    signUpWithGoogle: "",
    signUpWithApple: "",
    ...
    logIn: "Iniciar sesión",
    errors: {
      emailRequired: "El email no puede estar en blanco",
      emailInvalid: "Debe ser un email válido",
      passwordRequired: "La contraseña no puede estar en blanco",
