...
const ko: Translations = {
  ...
  registerScreen: {
    register: "등록",
    createAccount: "계정 만들기",
    enterDetails: "계정을 만들고 시작하기 위해 상세 정보를 입력하세요.",
    emailFieldLabel: "이메일",
    passwordFieldLabel: "비밀번호",
    confirmPasswordFieldLabel: "비밀번호 확인",
    emailFieldPlaceholder: "이메일을 입력하세요",
    passwordFieldPlaceholder: "안전한 비밀번호를 선택하세요",
    confirmPasswordFieldPlaceholder: "비밀번호를 다시 입력하세요",
    tapToRegister: "계정 만들기",
    orContinueWith: "",
    signUpWithGoogle: "",
    signUpWithApple: "",
