...
const ar: Translations = {
  ...
  registerScreen: {
    register: "تسجيل",
    createAccount: "إنشاء حساب",
    enterDetails: "أدخل التفاصيل الخاصة بك أدناه لإنشاء حسابك والبدء.",
    emailFieldLabel: "البريد الالكتروني",
    passwordFieldLabel: "كلمة السر",
    confirmPasswordFieldLabel: "تأكيد كلمة السر",
    emailFieldPlaceholder: "ادخل بريدك الالكتروني",
    passwordFieldPlaceholder: "اختر كلمة سر آمنة",
    confirmPasswordFieldPlaceholder: "أعد إدخال كلمة السر",
    tapToRegister: "إنشاء حساب",
    orContinueWith: "",
    signUpWithGoogle: "",
    signUpWithApple: "",
    ...
    logIn: "تسجيل الدخول",
    errors: {
      emailRequired: "لا يمكن أن يكون البريد الإلكتروني فارغًا",
      emailInvalid: "يجب أن يكون عنوان بريد إلكتروني صالح",
      passwordRequired: "لا يمكن أن تكون كلمة السر فارغة",
      passwordTooShort: "يجب أن تكون كلمة السر 6 أحرف على الأقل",
      confirmPasswordRequired: "يرجى تأكيد كلمة السر الخاصة بك",
