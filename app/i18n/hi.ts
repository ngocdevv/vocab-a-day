...
const hi: Translations = {
  ...
  registerScreen: {
    ...
    createAccount: "खाता बनाएं",
    enterDetails: "अपना खाता बनाने और शुरू करने के लिए नीचे अपना विवरण दर्ज करें।",
    emailFieldLabel: "ईमेल",
    passwordFieldLabel: "पासवर्ड",
    confirmPasswordFieldLabel: "पासवर्ड की पुष्टि करें",
    emailFieldPlaceholder: "अपना ईमेल पता दर्ज करें",
    passwordFieldPlaceholder: "एक सुरक्षित पासवर्ड चुनें",
    confirmPasswordFieldPlaceholder: "अपना पासवर्ड फिर से दर्ज करें",
    tapToRegister: "खाता बनाएं",
    orContinueWith: "",
    signUpWithGoogle: "",
    signUpWithApple: "",
    ...
    logIn: "लॉग इन करें",
    errors: {
      emailRequired: "ईमेल खाली नहीं हो सकता",
      emailInvalid: "एक वैध ईमेल पता होना चाहिए",
